...
namespace ChessForumWebApp.Repository
{
    public class ClubRepository : IClubRepository
    {
        ...
        {
            return await _context.Clubs.Include(i => i.Address).FirstOrDefaultAsync(a => a.Id == id);
        }
        public async Task<Club> GetByIdAsyncNoTracking(int id)
        {
            return await _context.Clubs.Include(i => i.Address).AsNoTracking().FirstOrDefaultAsync(a => a.Id == id);
        }
